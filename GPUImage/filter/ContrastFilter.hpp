...
public:
    static ContrastFilter* create(int contexID=0);
    bool init();
    virtual bool proceed(bool bUpdateTargets = true) override;
    
    void setContrast(float contrast_r,float contrast_g,float contrast_b);

protected:
    ContrastFilter() {}
    
    float _contrast_r,_contrast_g,_contrast_b;
};
